...
## Purpose
Оценка соответствия текущей архитектуры принципам DDD/Clean Architecture и список рекомендаций.

## Table of contents
- [Purpose](#purpose)
- [0) Контекст и оговорки](#0-контекст-и-оговорки)
- [1) Итоговая оценка (кратко)](#1-итоговая-оценка-кратко)
- [2) Карта слоёв и фактические зависимости (as-is)](#2-карта-слоёв-и-фактические-зависимости-as-is)
- [3) Что хорошо с точки зрения DDD/архитектуры](#3-что-хорошо-с-точки-зрения-dddархитектуры)
- [4) Найденные проблемы/DDD-smells (с объяснениями)](#4-найденные-проблемыddd-smells-с-объяснениями)
- [5) Рекомендации по улучшению (без изменения протокола и инвариантов)](#5-рекомендации-по-улучшению-без-изменения-протокола-и-инвариантов)
